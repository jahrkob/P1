...
def invSubBytes(big16inchInteger:int):
    """
    >>> hex(invSubBytes(0x7c266e85a762bddf7c266e85a762bddf))
    '0x123456789abcdef0123456789abcdef'
    """
    byteList = [invSubBytesTable[i]<<(120-index*8) for index, i in enumerate(list(big16inchInteger.to_bytes(16)))]
    return sum(byteList)
